...
them down each time.  But you can also generalize it, for example by making
the path \id{T} into a pentagon with scaling factor to $(3-\sqrt5)/2$,
or a hexagon with $1/3$.

\vbox to 0pt{\vskip -12pt $$\includegraphics{rec-sierpinski-pentagon.pdf}$$\vss}

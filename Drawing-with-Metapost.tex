...
but it is hard to write anything completely general (but see §\ref{sec:extimage} for an
example).
...
Apart from the curious patterns in the display, the only \MP\ point of interest
is the recursive "gcd" macro.\mpic{-108pt}{gons}

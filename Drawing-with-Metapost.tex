...
\begin{smallcode}
    label(btex \vbox{\hsize 4in 
     Nous étions à l'Étude, quand le Proviseur entra, suivi d'un \textit{nouveau}
     ...
     surpris dans son travail. \par} etex, 40 down);
\end{smallcode}
...
label(btex \vbox{\polytonic\halign{#\hfil\cr 
   Μῆνιν ἄειδε, θεά, Πηληϊάδεω Ἀχιλῆος\cr 
   οὐλομένην, ἣ μυρί\thinspace᾽ Ἀχαιοῖς ἄλγε᾽ ἔθηκε,\cr 
   ...
   Ἀτρεΐδης τε ἄναξ ἀνδρῶν καὶ δῖος Ἀχιλλεύς.\cr}} etex, 120 down);
\end{smallcode}

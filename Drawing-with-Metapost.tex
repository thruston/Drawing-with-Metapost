...
\textsc{For functions} that can have more than one value for $y$ for a given $x$,
you can generally rewrite the equation in parametric form, so that it depends on an
independent variable, as in $(x, y) = (\cos t, \sin t)$ for the unit circle.  

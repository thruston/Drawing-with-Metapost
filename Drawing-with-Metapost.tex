...
\textsc{You need} a different technique to generate an aperiodic tiling, like this
one that was discovered in the 1970s by the British polymath Sir Roger Penrose.  
...
tiling.  The tiling is made from two rhombus shapes, but each of these shapes can be
split in half into two triangles, and the expansion process actually works on each
of these triangles.

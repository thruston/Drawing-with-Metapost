...
drawn.\vadjust{\moveright300pt\vbox to 0pt{\vskip 74pt\begin{mplibcode}beginfig(0);drawarrow
origin {right} .. {dir 70} 42 dir 60;endfig;\end{mplibcode}\vss}}:
...
\newpage
\subsection{Making curves for functions}
...
\smallskip\noindent
However in general it is simpler just to increase the number of samples by making a
smaller step size.

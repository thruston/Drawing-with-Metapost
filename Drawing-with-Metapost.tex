...
\textsc{A selection} of mathematical graphs is presented in this section, mainly
taken from real examples collected over several years.  As ever in this document,
the focus is on plain \MP; the plain format provides no built-in facilities for
graphs so you have to do everything from scratch; but on the other hand there are no
new macros or commands to learn, you get full control of what goes on the page, and
you will not spend hours scratching your head wondering how to adjust the axis
labels.
...
\newpage
\subsection{Making curves for functions from path pieces}
...
symmetry in the path.  For example:\mwpic{-48pt}{curves-reflection}
\begin{code}
path ff, negative_ff;
...
negative numbers.\mwpic{-60pt}{curves-cuberoot}
...
\end{code}\vss}}
$$\includegraphics[width=\textwidth]{curves-sines.pdf}$$
...
\newpage
\subsection{Focus on a specific region of a curve}

\textsc{This visual proof} required a large $y$-axis scale.\mwpic{-24pt}{functions-epi-v-pie}
The axes are separated visually to show the
discontinuity.\enlargethispage\baselineskip
...
\newpage
\subsection{Cycloid and other spiral graphs}

\textsc{This section} examines cycloids; the curves made by points on the circumference of a

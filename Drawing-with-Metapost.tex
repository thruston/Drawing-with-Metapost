...
and open or closed.  Notice also that to find the mid-point of a line, you find the
...
\textsc{The Swedish mathetician} Helge von Koch\mpic{-30pt}{rec-koch-steps} originally devised the
Koch curve as an example of a non-differentiable curve that could be contructed with
...
at Level 1 on the right\ \rlap{$\longrightarrow$}\\
...
enddef;
\end{code}
The bottom line here was created with \mpl{draw koch(4, origin, 300 right)}.

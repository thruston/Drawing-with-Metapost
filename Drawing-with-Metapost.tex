...
\vss}
\noindent
The \mpl{withcolor} command will also take a single numeric instead of a 3-tuple or
...
number in \MP\ is: $\id{epsilon} = 1/256/256;$ you can have at most 65,536 shades in
between.
...
for \MP\ from my Github page: "http://github/thruston/metapost-colorbrewer".
This package provides two files that define all the colour ranges; one for CMYK and
...
\vss}
\newpage 
\subsection{Parallel and orthogonal}

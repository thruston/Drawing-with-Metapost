...
You can of course acheive the same effects using \LaTeX\ tabular structures, but
...
marks that deal with pictures, but the contents are taken verbatim, so that the
...
To get round this sort of problem, \MP\ provides a general mechanism to write out a
...
correct contents to pass to \TeX.  The trouble with this is that it makes \MP\ open a file,

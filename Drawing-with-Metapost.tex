...
\le 1$ and then transform as required, but it can be illuminating to follow more
...
\newpage
\subsection{Simulating physical construction}
...
\noindent\mpic{48pt}{tufte-mpg}\marginpar{The complete Lua\TeX\ document shows the
use of "fontspec" to get the Palatino-like font.}

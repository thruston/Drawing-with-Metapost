...
\newpage
\subsection{Logarithmic spiral and the golden rectangle}
...
it.\mpic{-24pt}{curves-spiral-gnomon-sq}
...
numeric a, b, t; a = 1; b = 1;
for i = 1 upto n:
  t := b; b := b + a; a := t;
  if a > 5:
    label(TEX(decimal a) rotated angle point n of s[n], center s[i]);
  fi
endfor

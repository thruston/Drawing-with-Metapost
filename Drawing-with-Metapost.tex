...
the contents of these variables are a bit more complicated that a pattern of pixels
for a font.  Like \MF, \MP\ keeps track of the picture it is working on in a
variable called \mpl{currentpicture}, which can be copied to your own variables, or
manipulated in various useful ways.  This section reviews some of the things you can 
do with a \<picture> variable.

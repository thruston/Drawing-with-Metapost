...
\newpage
\subsection{Drawing on an external image}
...
variable.\vadjust{\moveright 396pt\vbox to 0pt{\hsize 4in\vskip -36pt
$$\includegraphics{border.pdf}$$
\begin{smallcode}
% don't take this one too seriously...
vardef rope expr c = 
save hemp; color hemp; hemp = 1/256 (224, 202, 169);      
image(draw c withpen pencircle scaled 2.16 withcolor hemp;
for t=0 step 2 until arclength c: draw
    up rotated angle direction arctime t-3 of c of c 
                 shifted point arctime t-3 of c of c
 .. up rotated angle direction arctime t-1 of c of c 
                 shifted point arctime t-1 of c of c
 .. down rotated angle direction arctime t+1 of c of c 
                   shifted point arctime t+1 of c of c
 .. down rotated angle direction arctime t+3 of c of c 
                   shifted point arctime t+3 of c of c
...
Call outss - overbrace, underbrace, length arrows etc, ahangle trick

...
\newpage
\centerline{Work in progress}
\begin{verbatim}
currentpicture       picture    †  Accumulate results 
                                   of draw and fill commands
...
center picture                   --> pair
llcorner picture                 --> pair
lrcorner picture                 --> pair
ulcorner picture                 --> pair
urcorner picture                 --> pair
bbox picture                     --> path

picture rotated numeric          --> picture
picture shifted pair             --> picture
picture slanted numeric          --> picture
picture scaled numeric           --> picture
picture xscaled numeric          --> picture
picture yscaled numeric          --> picture
picture zscaled pair             --> picture
picture transformed transform    --> picture

string infont string             --> picture
textext(string)  --> picture
image(string)                    --> picture

thelabel.suffix(picture, pair)   --> picture
thelabel.suffix(string, pair)    --> picture

dotlabel.suffix(picture, pair)   --> –
label.suffix(picture, pair)      --> –
\end{verbatim}


Making a large pic out of pieces / nb they are transparent

Aligning them with labels

Adding labels to current picture

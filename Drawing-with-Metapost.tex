...
the final image using \mpl{draw} as shown on the right
$\longrightarrow$\vadjust{\moveright 396pt\vbox to 0pt{\hsize 4in \vskip -81pt
...
advantage of the automatic alignment provided.  Note also that the blank parts of
each picture are really transparent, unless you have explicitly filled them with
...
\newpage
\subsection{Drawing with various colours and pens}
...
Or just something on the lowest layer.

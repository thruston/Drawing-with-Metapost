...
\bigskip
\noindent\hbox to \textwidth{\includegraphics[scale=0.92]{axis1}\hss}
\vadjust{\moveright5.5in\vbox to 0pt{\hsize 4in\vss\noindent
...
\newpage
\subsection{Inversion, pole, and polar}
...
slightly more general macro that can invert a \mptype{pair} (or a \mptype{path}) $P$
in a circle $C$.
\begin{smallcode}
...
\newpage
\subsection{Radical axis and radical centre}

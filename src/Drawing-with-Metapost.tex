...
\vss}}
\mpexternal[linerange=25-29]{trad-utf8.mp}
...
\newpage
\section{Number lines and sequence digrams}\label{timelines}
...
use a consistent unit size.  Here is a simple line showing numbers upto 10.
$$
\begin{mplibcode}
numeric u; u = 24; path axis; axis = origin -- 11u * right;
    drawarrow axis; for i = 0 upto 10: draw (2 up -- 2 down) shifted (i*u,0);
    label.top(decimal i, (i*u, 2));
    endfor

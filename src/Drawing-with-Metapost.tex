...
\mpexternal[linerange=6-18]{color-blend-toy.mp}
\vss}}
...
\newpage
\subsection{Extended ranges of colour names}

If you want to use a wider range of colour names you can load the "mpcolornames" 
package, which defines the three usual sets of names used for DVIPS, SVG, and X11. The
figure\mpic{-36pt}{color-svgnames} at the right shows the charmingly
idiosyncratic X11 
...
this:
\begin{code}
  fill fullcircle scaled 20 withcolor mplibtexcolor "squash";
  fill fullcircle scaled 12 withcolor mplibtexcolor "carrot";
\end{code}
...
that you can write
\begin{code}
  fill fullcircle scaled 20 withcolor mplibtexcolor "green!70";
  fill fullcircle scaled 12 withcolor mplibtexcolor "blue!42!red";
\end{code}
...
\medskip
\noindent
Note that at the \MP\ level, the name is just a \<string>; the \mpl{mplibtexcolor}
operator turns it into a \<color> or a \<cmykcolor> as appropriate.
...
\begin{mplibcode}
    fill fullcircle scaled 42 withcolor mplibcolor "orange";
\end{mplibcode}

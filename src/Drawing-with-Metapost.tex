...
\mpexternal[linerange=7-13]{seq-simple-line.mp}
The unit $u$ is used to scale the axis to the right size and then to position each
of the labels.  {\small But notice that even with this very simple starting point some care

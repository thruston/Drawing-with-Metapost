...
exactly $1/1024$. You will find that \mpl{base(1,1,1)} returns 0, and \mpl{base(2001,1,1)} returns
$713.36426$.
...
\smallmpexternal[linerange=52-53]{seq-covid-in-wales.mp} 
...
a horizontal scale.\\[6pt]
\rightline{— \textit{The diagram was adapted from one originally created by the BBC}.}\par\vss}

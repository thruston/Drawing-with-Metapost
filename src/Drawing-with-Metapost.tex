...
Copyright \copyright\ 2025 by Toby Thurston. This material may be distributed only
...
\smallmpexternal[linerange=6-19]{trad-braces.mp}
\smallmpexternal[linerange=28-28]{trad-braces.mp}
\noindent
...
\begin{itemize}
    \item \mpl{mplibdimen} takes a \<string> and returns a \<numeric>.
\end{itemize}
...
should return 432 (approximately).

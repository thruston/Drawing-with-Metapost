...
\def\mpic#1#2{\vadjust{\moveright5.5in\vbox to 0pt{\vskip#1\includegraphics{#2}\vss}}}
...
I’ve written myself --- if you want other people’s ideas then visit the site.
While the main focus of the site is writing \LaTeX\ documents, there are a great
...
\newpage\subsection{Simulating rough edges or rough surfaces}

In this adjacent

- drawing jagged edges
